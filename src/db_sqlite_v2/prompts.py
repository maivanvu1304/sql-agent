def generate_query_system_prompt(dialect: str):
    """
...
- If the user asks for a specific "page" or "next set" of results, you should use the `LIMIT ... OFFSET ...` clause. Assume each page has 10 results unless specified otherwise. For example, 'page 2' means `LIMIT 10 OFFSET 10`, 'page 3' means `LIMIT 10 OFFSET 20`.
